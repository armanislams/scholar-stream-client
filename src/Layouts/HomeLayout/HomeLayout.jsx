      ...
      <section className="py-10 bg-base-100">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-200 hover-lift">
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Our AI-powered algorithm finds scholarships perfectly suited
                  to your profile, interests, and goals.
                </p>
              </div>
            </div>
            ...
            {/* Feature 2 */}
            <div
              className="card bg-base-200 hover-lift"
            ...
            >
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Streamlined application process with saved profiles and
                  one-click submissions to multiple scholarships.
                </p>
              </div>
            </div>
            ...
            >
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Get instant notifications about new scholarships, deadlines,
            ...
            >
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Access tips, essay examples, and expert advice to strengthen
            ...
            >
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  ...
                  encryption and privacy standards.
                </p>
              </div>
            </div>
            ...
            >
              <div className="card-body">
                ...
                <p className="text-base-content/70">
                  Join a thriving community of students sharing experiences,
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="join join-vertical w-full bg-base-100 shadow-xl rounded-2xl border border-base-200">
            <div className="collapse collapse-plus join-item border-b border-base-200">
              ...
              <div className="collapse-content">
                <p className="opacity-70">
                  Simply create an account, browse our extensive list of
                  scholarships, select the one that fits you, and click 'Apply'.
                  You'll need to pay any application fees via our secure payment
                  gateway.
                </p>
              </div>
            </div>
            <div className="collapse collapse-plus join-item border-b border-base-200">
              ...
              <div className="collapse-content">
                <p className="opacity-70">
                  Usually, you'll need academic transcripts, a statement of
                  purpose, and identification. Specific requirements vary by
            ...
            <div className="collapse collapse-plus join-item border-b border-base-200">
              ...
              <div className="collapse-content">
                <p className="opacity-70">
                  Browsing is free! Some scholarships have application
                  processing fees which are clearly listed on the details page.
            ...
            <div className="collapse collapse-plus join-item">
              ...
              <div className="collapse-content">
                <p className="opacity-70">
                  You can edit your application details only while it is in
                  'Pending' status. Once a moderator starts processing it, it
                  cannot be modified to ensure integrity.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-10 gradient-primary relative overflow-hidden mt-10 rounded-md">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of students who are already on their path to academic
            success. Create your free account today and discover scholarships
            waiting for you.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to={"/register"}
              className="btn btn-lg bg-white text-purple-600 hover:bg-white/90 border-none px-8"
            >
              Create Free Account
            </Link>
            <Link
              to="/faq"
              className="btn btn-lg glass-card text-white border-white/30 hover:bg-white/20 px-8"
            >
              Learn More
            </Link>
          </div>
