          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="btn btn-circle btn-sm bg-base-100 hover:bg-gradient-primary hover:text-white border-none"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
                    className="text-base-content/70 hover:text-purple-600 transition-colors"
                  >
                    Browse Scholarships
                  </a>
                </li>
            ...
            <div>
              ...
              <div className="join w-full">
                ...
                />
                <button className="btn btn-gradient join-item">
                  Subscribe
                </button>
              </div>
            </div>
