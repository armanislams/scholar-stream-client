...
const Card = () => {
    return (
      <div class="group bg-gray-900/95 border border-purple-800/30 rounded-2xl p-6 hover:bg-gray-900 hover:border-purple-500/50 transition-all duration-300 shadow-md shadow-black/30 hover:shadow-purple-500/10">
        <div class="flex justify-between items-start mb-5">
          <div>
            <h3 class="text-2xl font-bold bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              Gates Scholarship
            </h3>
